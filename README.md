...
We are at a crossroads in AI development, fast approaching AGI and superintelligent Autonomous AI. There are many valid concerns ranging from **security, identity theft, misalignment, and malicious bad faith actors.** Currently, AI alignment research is severely lagging behind other advancements in AI technology. **Alignment of AI is an urgent matter** which I believe the vast majority of society has had little to no say on.
